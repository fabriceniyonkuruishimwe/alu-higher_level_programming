...
class Rectangle:
    ...
    def __init__(self, width=0, height=0):
        ...
        Args:
            width: The width of the new Rectangle (default 0).
            height: The height of the new Rectangle (default 0).
        """
        self.width = width
        self.height = height
    ...
    def __str__(self):
        ...
        Uses the symbol stored in print_symbol, and returns an
    ...
    def square(cls, size=0):
        ...
        Args:
            size: The size for both width and height (default 0).
        """
